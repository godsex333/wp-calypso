			...
			<Main className="gmb-new-account" wideLayout>
				...
				<Checklist>
					<Task
						...
						buttonText="Connect"
						buttonPrimary
						completedTitle="You are connected to your Google Search Console"
					...
					<Task
						...
						buttonText="Add"
						buttonPrimary
						completedTitle="You have added your site to your Google Search Console"
						description="Set up your Google Search Console to manage your site"
						duration="1 minute"
					...
					<Task
						...
						title="Connect to Google My Business to manage your business listing"
						buttonText="Connect"
						buttonPrimary
						completedTitle="You are managing your business listing on Google My Business"
						description="Enable this free tool, and be there when customers search businesses like yours on Google Search and Maps"
						duration="5 minutes"
